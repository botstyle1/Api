...
try {
var zahirr = db.get("zahirr__path = process.cwd()
var favicon = require('serve-favicon');
var express = require('__path = process.cwd()
var favicon = require('serve-favicon');
var express = require('express');
var db = require(__path + '/database/db');
try {
...
router.get('/anime/husbu', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/bahan-api/main/husbu.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/anime/waifu', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/bahan-api/main/waifu.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/anime/nekonime', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/bahan-api/main/neko.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/anime/randomanime', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/bahan-api/main/random.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
