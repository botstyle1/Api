...
var express = require('express__path = process.cwd()
var favicon = require('serve-favicon');
...
const listkey = ["benniismaelapikey", "administrataor", "iCiroNV"];
...
router.get('/artinama', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.caranya.my.id/primbon/artinama?q=${nama}`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/artimimpi', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.caranya.my.id/primbon/artimimpi?q=${mimpi}`))
        .then(response => response.json())
        .then(data => {
             var result = data;
             res.json({
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/Api/master/lib/utils/caklontong.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakbendera', async (req, res, next) => {
  ...
  if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/Api/master/lib/utils/tebakbendera.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/family100', async (req, res, next) => {
  ...
  if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/Api/master/lib/utils/family100.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/siapakahaku', async (req, res, next) => {
  ...
  if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/Api/master/lib/utils/siapakahaku.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebaklirik', async (req, res, next) => {
  ...
  if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/botstyle1/Api/master/lib/utils/tebaklirik.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/textpro/pornhub', async (req, res, next) => {
  ...
  if(!text2) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text2"})
      ...
      hasil = (`https://api.xteam.xyz/textpro/ph?text=${text1}&text2=${text2}&APIKEY=benniismaelapikey`)
     data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync('tolol.png', data)
        res.sendFile(__path+'/tolol.png')
         .catch(e => {
